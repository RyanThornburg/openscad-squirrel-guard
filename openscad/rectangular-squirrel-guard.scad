/*
 * Squirrel Guard - Rectangular Parametric Flower Box Cover v9
 * ==============================================================
 ...
 *
 * Upload to MakerWorld for a live Customize button.
 * Compatible with OpenSCAD 2021.01.
 *
 * HOW SEGMENTS WORK
 * -----------------
 * segment_to_print = 0  → full preview
 * segment_to_print = 1+ → individual piece re-centred at origin
 * Pieces numbered left-to-right, bottom-to-top.
 */
...
VALID_SLOTS = [
  for (col = [0:SLOT_COLS - 1], row = [0:SLOT_ROWS - 1]) let (
